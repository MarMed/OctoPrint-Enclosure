    ...
    function EnclosureViewModel(parameters) {
        ...
        self.setTemperature = function(){
            if(self.isNumeric($("#enclosureSetTemp").val())){
                $.ajax({
                    url: "/octoprint/plugin/enclosure/setEnclosureTemperature",
                    type: "GET",
                    dataType: "json",
        ...
        self.clearGPIOMode = function(){
            $.ajax({
                url: "/octoprint/plugin/enclosure/clearGPIOMode",
                type: "GET",
                dataType: "json",
                 success: function(data) {
        ...
        self.getUpdateBtnStatus = function(){
            ...
            $.ajax({
                url: "/octoprint/plugin/enclosure/getUpdateBtnStatus",
                type: "GET"
            });
        };
        ...
        self.requestEnclosureTemperature = function(){
            return $.ajax({
                    type: "GET",
                    url: "/octoprint/plugin/enclosure/getEnclosureTemperature",
                    async: false
                }).responseText;
        };
        ...
        self.requestEnclosureSetTemperature = function(){
            return $.ajax({
                    type: "GET",
                    url: "/octoprint/plugin/enclosure/getEnclosureSetTemperature",
                    async: false
                }).responseText;
        };
        ...
        self.handleIO = function(data, event){
            $.ajax({
                    ...
                    url: "/octoprint/plugin/enclosure/setIO",
                    async: false
            });
        };
        ...
        self.handlePWM = function(data, event){
            ...
            if(pwmVal<0 || pwmVal>100 || isNaN(pwmVal)){
              ...
              $.ajax({
                      ...
                      url: "/octoprint/plugin/enclosure/setPWM",
              });
            }
        };
        ...
        self.handleNeopixel = function(data, event){
            ...
            if(r<0 || r>255 || g<0 || g>255 || b<0 || b >255 || isNaN(r) || isNaN(g) || isNaN(b)){
              ...
              $.ajax({
                      ...
                      url: "/octoprint/plugin/enclosure/setNeopixel",
              });
            }
        };
